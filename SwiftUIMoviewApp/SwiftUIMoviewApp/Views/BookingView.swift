...
struct BookingView: View {
  ...
  var body: some View {
    ZStack {
      ...
      VStack{
        LinearGradient(colors: grediant, startPoint: .top, endPoint: .bottom)
          .frame(height: 600)
      }
      ...
      VStack {
        ...
        HStack(alignment: .top, spacing: 20.0){
          ...
          DateButton(weekDay: "Fri", numDay: "22", isSelected: $bindingSelection)
            .padding(.top,70)
          DateButton(weekDay: "Sat", numDay: "23",width: 70.0,height: 100, isSelected: $bindingSelection , action: {
